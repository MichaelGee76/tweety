...
import { doJwtAuth, validateRefreshTokenInCookieSession } from "../middlewares/authentication.js";
...
export const userRoutes = express
    ...
    .post("/refresh-token", validateRefreshTokenInCookieSession, userController.postRefreshTokenCtrl);
