...
const VerifyEmail = () => {
    ...
    const verifyEmailHandler = async (event) => {
        ...
        setErrorMessage("");
        setSuccessMessage(`${user.firstName} you have verified your email successfully`);
        console.log(data);
    };
    return (
        <main>
            ...
            <form>
                ...
                <div>
                    ...
                    <input id="sixDigitCode" type="text" value={sixDigitCode} onChange={(event) => setSixDigitCode(event.target.value)} />
                </div>
